...
public class DefaultUserInfo implements UserInfo {
	...
	public static final List<String> DEFAULT_FIELDS =
	  Arrays.asList(new String[] {
		...
		"zone_info", "locale", "updated_time", "birthdate", "email",
	...
	/**
	 * Constructs a new DefaultUserInfo object.
	 */
	...
	/**
	 * Returns true if the given property can be a custom property.
	 */
	public boolean isValidCustomField(String name) {
		if (name == null)
			return false;
		return !DEFAULT_FIELDS.contains(name);
	}
	...
	/**
	 * Updates the map of custom fields.
	 *
	 * @param values The new map of custom fields.
	 */
	public void setCustomFields(Map<String, String> values) {
		if (values == null)
	...
	/**
	 * Sets the given custom field in this JSON object.
	 *
	 * @param name The name to set.
	 * @param value What to put at that key.
	 */
	public void setCustomField(String name, String value) {
		if (!isValidCustomField(name))
			throw new IllegalArgumentException(
				"Invalid custom field name: " + name);
	...
	/**
	 * Retreives the given field from this UserInfo object.
	 *
	 * @param name The field name to retrieve.
	 * @returns the value of that field.
	 */
	public String getField(String name) {
		return this.toJson().getAsJsonPrimitive(name).getAsString();
	}
	...
	public JsonObject toJson() {
		...
		for (String name : customFields.keySet())
			obj.addProperty(name, customFields.get(name));
	...
	public static UserInfo fromJson(JsonObject obj) {
		...
		for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
			ui.setCustomField(entry.getKey(), entry.getValue().getAsString());
		}
